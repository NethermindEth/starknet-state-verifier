...
describe("Verify", function () {
  ...
  async function getVerifiedStorageValue(contractAddress: BigNumberish, storageVarAddress: BigNumberish, filename: string) {
  ...
  it("it should verify the sampleproof1.json", async function () {
    ...
    var result = await getVerifiedStorageValue(contractAddress, storageVarAddress, jsonFile);
  ...
  it("it should verify the sampleproof2.json", async function () {
    ...
    const contractAddress = "0x048a64f708011fb5089778204f37d6111bd9bbac0fe4b6e7851292b8cbeeb6ef";
    const storageVarAddress = "0x3284999a2939a8b54b2831813deb324170904a9a5145470eca917d66eb69708";
    const expectedStorageVarValue = "0x1C62C52C1709ACB3EB9195594E39C04323658463CFE0C641E39B99A83BA11A1";
    var result = await getVerifiedStorageValue(contractAddress, storageVarAddress, jsonFile);
    console.log("Result: " + result);
    expect(result).to.equal(expectedStorageVarValue);
  });
  ...
  it("it should verify the sampleproof3.json", async function () {
    ...
    const storageVarAddress = "0x5b591ebdce191ad38e7c15ddf7b7913c3756c431f6e6e684e87c1f87023a0fe";
